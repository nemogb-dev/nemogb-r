...
Contributions to `nemogb` whether in the form of bug fixes, issue
...
package for users. We are eager to include and accepting of
contributions from everyone that meets our [code of
conduct](https://github.com/nemogb-dev/nemogb-r/CODE_OF_CONDUCT.md)
guidelines.
...
`nemogb` uses `testthat` for testing. Please try to provide 100% test
...
code are not over 80 characters and that all lines of code have tests
written. Please do so prior to submitting any pull request and fix any
suggestions from there. Reach out to us if you need any assistance there
too.
...
style](http://style.tidyverse.org/) for R.
