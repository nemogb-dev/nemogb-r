...
test_that("drop_n_lowest function - n < num of assignments", {
  ...
  actual <- drop_n_lowest(grades_mat,
    policy_line = 2, category = "Labs",
    assignments = c("Lab 1", "Lab 2", "Lab 3", "Lab 4")
  )
  expected <- tibble::tibble(
    `Lab 1` = c(NA, NA, NA, 0.8, NA),
...
test_that("drop_n_lowest function - n == num of assignments", {
  ...
  actual <- drop_n_lowest(grades_mat,
    policy_line = 4, category = "Labs",
    assignments = c("Lab 1", "Lab 2", "Lab 3", "Lab 4")
  )
  expected <- tibble::tibble(
    `Lab 1` = c(NA, NA, NA, NA, NA),
...
test_that("aggregation function - equally_weighted", {
  ...
  actual <- equally_weighted(grades_mat,
    category = "Labs",
...
test_that("aggregation function - weighted_by_points", {
  ...
  actual <- weighted_by_points(grades_mat,
    category = "Labs",
    assignments = c("Lab 1", "Lab 2")
  )
  expected <- grades_mat
...
test_that("aggregation function - weighted_mean", {
  gs <- tibble::tibble(
    `Labs` = c(0.5, 0.4, 0.3, 0.8),
    `Final_Exam` = c(0.8, 1.0, 0.2, 0.9),
    Overall_Grade = NA
  )
  grades_mat <- as.matrix(gs)

  actual <- weighted_mean(grades_mat,
...
test_that("aggregation function - weighted_mean if wrong number of weights", {
  ...
  expect_error(weighted_mean(grades_mat,
    category = "Overall_Grade",
...
test_that("aggregation for max pts - mean_max_pts", {
  ...
  actual <- mean_max_pts(grades_mat,
    category = "Labs",
    assignments = c("Lab 1", "Lab 2")
  )
  expected <- grades_mat
...
test_that("lateness function - until", {
  gs <- tibble::tibble(
    `Lab 1 - Lateness (H:M:S)` = c(20, 40, 60, 80, 100),
    `Lab 2 - Lateness (H:M:S)` = c(10, 30, 50, 70, 90)
  )
  grades_mat <- as.matrix(gs)

  actual <- until(grades_mat,
    late_policy = "01:00:00", original_late_mat = grades_mat,
    assignments = c("Lab 1", "Lab 2")
  )
  expected <- grades_mat
...
test_that("lateness function - between", {
  ...
  actual <- between(grades_mat,
    late_policy = list("00:30:00", "01:00:00"), original_late_mat = grades_mat,
    assignments = c("Lab 1", "Lab 2")
  )
  expected <- grades_mat
...
test_that("lateness function - between with backwards from and to", {
  ...
  actual <- between(grades_mat,
    late_policy = list("01:00:00", "00:30:00"), original_late_mat = grades_mat,
    assignments = c("Lab 1", "Lab 2")
  )
  expected <- grades_mat
  expected[, "Lab 1 - Lateness (H:M:S)"] <- c(0, 1, 1, 0, 0)
...
test_that("lateness function - add", {
  ...
  grades_mat <- tibble::tibble(
    `Lab 1` = c(0.75, 0.85, 0.9, 1.0, 1.0),
...
test_that("aggregation for lateness function - sum_lateness", {
  ...
  actual <- sum_lateness(grades_mat,
    category = "Labs",
    assignments = c("Lab 1", "Lab 2")
  )
  expected <- grades_mat
...
test_that("aggregation for lateness function - mean_lateness", {
  ...
  actual <- mean_lateness(grades_mat,
    category = "Labs",
    assignments = c("Lab 1", "Lab 2")
  )
  expected <- grades_mat
...
test_that("aggregation for lateness function - max_lateness", {
  ...
  actual <- max_lateness(grades_mat,
    category = "Labs",
    assignments = c("Lab 1", "Lab 2")
  )
  expected <- grades_mat
