...
Note that setting the `append = TRUE` in the `get_grades()` function will output a data frame of the ID columns and the newly calculated scores (excluding the original assignment columns from Gradescope).
...
plot(
  x = script_grades$`Overall Grade`, grades$`Overall Grade`,
